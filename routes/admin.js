...
function check_staff(req, res) {
    ...
    if (user.UserType === 'staff' || user.UserType === 'Staff' || user.Usertype==='Customer') {
        res.redirect('/admin');
        return;
    }
}
...
router.get('/sale', function (req, res) {
    ...
    var query1= "SELECT medicine_Name FROM m"
...
router.get('/custbuy', function (req, res) {
    var query = "SELECT b.*, m.Medicine_Name, s.Supplier_Name FROM batch b INNER JOIN medicine_information m on b.Medicine_ID = m.ID INNER JOIN supplier s on b.Supplier_ID = s.ID";
    ...
    db.getData(query, null, function (rows) {
        ...
        res.render('custbuy', data);
    });
});

router.post('/custbuy', function (req, res) {
    var billInfo = {
...
router.get('/custmed', function (req, res) {
...
router.get('/usermanagement/delid=:id', function (req, res) {
    ...
    var query2 = "DELETE FROM user_access WHERE Username = ?";
    var query = "DELETE FROM user_information WHERE Username = ?";
    db.getData(query, id, function (rows) {
